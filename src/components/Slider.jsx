...
const Slider = () => {
  ...
  return (
    <div className="text-white flex relative h-screen overflow-hidden">
      <div
        className="h-screen flex transition-all duration-1000 ease-in-out"
        style={{ transform: `translateX(${slideIndex * -100}vw)` }}
      >
        <div className="flex-1 flex h-[80%] w-screen bg-blue-200">
          ...
          <div className="flex-1 p-14">
            ...
            <p className="text-2xl m-4 tracking-widest">
              Get your right style now with Va as Compras
            </p>
